...
class listcek extends Component {
  state = {
    searchValue: "",
    meals: []
  ...
  makeApiCall = searchInput => {
    var searchUrl = `https://stok.bakulansayur.com/index.php?tbl=logopname&col2=barcode&nm=meals&df=${searchInput}`;
    fetch(searchUrl)
      .then(response => {
...
onClick={this.handleSearch}>lihat</Button>
